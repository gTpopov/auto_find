<?php
    ...
    $cs->registerScriptFile( Yii::app()->baseUrl.'/js/lib/jquery.cookie.js')
        ->registerScriptFile( Yii::app()->baseUrl.'/js/lib/jquery.autocomplete.js')
        ->registerCssFile(Yii::app()->baseUrl.'/css/lib/autocomplete.css')
        ->registerCssFile(Yii::app()->baseUrl.'/css/registry/default.css');
...
<script type="text/javascript"> $(function(){ $(".btn").click(function(){ $(this).val('<?php echo Yii::t('registrationPage','Waiting...'); ?>'); }); }); </script>
    ...
    <h3 class="text-center"><?php echo Yii::t('registrationPage','Registration'); ?></h3>
    ...
    <?php $this->endWidget(); ?>
    <img src="/images/shadow-bottom-img.png" id="shadow">